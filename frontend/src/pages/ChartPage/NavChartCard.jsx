...
const NavChartCard = ({count, action}) => {
  return (
    <div className="max-w-sm p-6 bg-gray-600 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p>
            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-white">{count} {action}</h5>
        </p>
        <p className="mb-3 font-normal text-white">
            There are {count} of {action}
        </p>
    </div>
  )
}
