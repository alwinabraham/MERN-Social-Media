    ...
    <Card>
        ...
        <div className='flex gap-3 items-center mt-2'>
            <div>
                ...
                <p className='text-xs sm:text-sm md:text-base xl:text-xl'>People</p>
                </button>
            </div>
            <div>
                <button className='flex items-center gap-1'>
                ...
                <p className='text-xs sm:text-sm md:text-base xl:text-xl'>Check in</p>
                </button>
            </div>
            <div>
                <button className='flex items-center gap-1'>
                ...
                <p className='text-xs sm:text-sm md:text-base xl:text-xl'>Mood</p>
                </button>
            </div>
