  ...
  return (
    <>
        {posts.map(obj=>(
            ...
            <div className='mt-3 flex gap-8' onClick={()=>{setPost(obj._doc._id);setLike(!like)}}>
                ...
                <form>
                    <div className='flex items-center'>
                        <div className='border grow rounded-full'>
                            <input className='block border w-full grow p-3 px-4 h-12 overflow-hidden rounded-full' placeholder='leave a comment' />
                        </div>
                        <div>
                            <button>Send</button>
                        </div>
