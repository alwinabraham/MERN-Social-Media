  ...
  return (
    <>
      {notifications.map(obj=>(
        <div className="w-full p-3 sm:mt-8 bg-white rounded flex">
            ...
            <div className="pl-3">
                <div className='flex text-xs sm:text-sm md:text-base xl:text-xl'><NameComponent userId={obj.userId}/><p>__</p>{obj.notification}<p>__</p>item</div>
                <p tabindex="0" className="focus:outline-none text-xs sm:text-sm md:text-base xl:text-xl'leading-3 pt-1 text-gray-500"><Timeago date={obj.createdAt} /></p>
            </div>
        </div>
      ))}
    </>
